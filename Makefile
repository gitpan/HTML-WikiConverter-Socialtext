# This Makefile is for the HTML::WikiConverter::Socialtext extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/HTML/WikiConverter/Socialtext.pm]
#     AUTHOR => q[Kirsten L. Jones <kirsten@gmail.com>]
#     NAME => q[HTML::WikiConverter::Socialtext]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], URI=>q[1.35], HTML::WikiConverter=>q[0.54] }
#     VERSION_FROM => q[lib/HTML/WikiConverter/Socialtext.pm]
#     clean => { FILES=>q[HTML-WikiConverter-Socialtext-*] }
...
NAME_SYM = HTML_WikiConverter_Socialtext
VERSION = 0.01
...
FULLEXT = HTML/WikiConverter/Socialtext
BASEEXT = Socialtext
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/HTML/WikiConverter/Socialtext.pm
...
TO_INST_PM = lib/HTML/WikiConverter/Socialtext.pm

PM_TO_BLIB = lib/HTML/WikiConverter/Socialtext.pm \
...
DISTNAME = HTML-WikiConverter-Socialtext
DISTVNAME = HTML-WikiConverter-Socialtext-0.01
...
manifypods : pure_all  \
	lib/HTML/WikiConverter/Socialtext.pm \
	lib/HTML/WikiConverter/Socialtext.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/HTML/WikiConverter/Socialtext.pm $(INST_MAN3DIR)/HTML::WikiConverter::Socialtext.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/HTML/WikiConverter/Socialtext.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         HTML-WikiConverter-Socialtext' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/HTML/WikiConverter/Socialtext.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    HTML::WikiConverter:           0.54' >> META.yml
	$(NOECHO) $(ECHO) '    Test::More:                    0' >> META.yml
	$(NOECHO) $(ECHO) '    URI:                           1.35' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Convert HTML to Socialtext markup</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Kirsten L. Jones &lt;kirsten@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="HTML-WikiConverter" VERSION="0,54,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/HTML/WikiConverter/Socialtext.pm blib/lib/HTML/WikiConverter/Socialtext.pm 
	$(NOECHO) $(TOUCH) $@
